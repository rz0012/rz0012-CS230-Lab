    ...
    ?>
        ...
        <div class="h-50 center-me text-center">
            ...
            <div class="my-auto">
                ...
                <form action="includes/gallery_helper.php" method="POST" enctype="multipart/form-data">

                    <div class="form-group">
                        <img src="images/login_img4.jpg" alt="profile pic" onclick="triggered();" id="gallery-display">
